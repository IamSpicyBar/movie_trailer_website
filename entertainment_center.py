...
# Different instances of movies
fellowship_of_ring = media.Movie("""The Lord of the Rings:
...
return_of_king = media.Movie("The Lord of the Rings: The Return of the King",
                             """A great battle with extrordinary pictures
                             and motions""",
...
farewell_concubine = media.Movie("Farewell My Concubine",
                                 """Two male stars' life in
                                 a Peking opera troupe""",
                                 "https://upload.wikimedia.org/wikipedia/en/c/c5/Farewell_My_Concubine_poster.jpg",  # NOQA
                                 "https://www.youtube.com/watch?v=cC-_SLiRnJE")

attorney = media.Movie("The Attorney",
                       """A lawyer fights for students tortured
                       by government power""",
                       "https://upload.wikimedia.org/wikipedia/en/b/b5/The_Attorney_poster.jpg",  # NOQA
                       "https://www.youtube.com/watch?v=QDaG0IF7ucc")

departures = media.Movie("Departures",
                         """Story about a traditional Japanese
                         ritual mortician""",
                         "https://upload.wikimedia.org/wikipedia/en/e/e1/Okuribito_%282008%29.jpg",  # NOQA
                         "https://www.youtube.com/watch?v=6UFlWO5zhO8")

# Get a list of movies, and implement the website
movies = [fellowship_of_ring, two_towers, return_of_king,
          farewell_concubine, attorney, departures]
